...
function LandingPage() {
  ...
  return (
    <div className="h-screen flex items-center sm:flex-col">
      ...
      >
        <h1>
          <b className="text-[#2B8F74] text-8xl">HMD</b>{" "}
          <b className="text-8xl text-gray-700">NEWS</b>
        </h1>
        <p className="text-lg">
          Organise et met en avant les informations du monde entier pour vous
          permettre d'en savoir plus sur les sujets qui vous intéressent
          vraiment. Suivez l'actualité de votre communauté grâce à des articles
          provenant de médias d'information locaux, afin de savoir ce qui se
          passe autour de vous, où que vous soyez.
        </p>
